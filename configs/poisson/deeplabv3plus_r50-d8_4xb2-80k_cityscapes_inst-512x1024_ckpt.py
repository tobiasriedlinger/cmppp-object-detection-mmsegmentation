...
model = dict(
    pretrained='/work/riedlinger/projects/kira/point_processes_seg/mmsegmentation/checkpoints/deeplabv3plus_r50-d8_512x1024_40k_cityscapes_20200605_094610-d222ffcd.pth',
    backbone=dict(
        requires_grad=False
    ),
